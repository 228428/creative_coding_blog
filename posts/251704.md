...
<script type= "module">
    ...
    const  height = width * 9/16
			...
			import { TeapotGeometry } from '/scripts/251704/three.js-masters//examples/jsm/geometries/TeapotGeometry.js';
			...
			function init() {
				...
				// TEXTURE MAP
				const textureMap = new THREE.TextureLoader().load( '/scripts/251704/three.js-master/textures/uv_grid_opengl.jpg' );
				textureMap.wrapS = textureMap.wrapT = THREE.RepeatWrapping;
				textureMap.anisotropy = 16;
				textureMap.colorSpace = THREE.SRGBColorSpace;

				// REFLECTION MAP
				const path = '/scripts/251704/three.js-master/textures/cube/pisa/';
